...
class AdapterClass (private val dataList:ArrayList<Chest>): RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    val ITEM =0
    val FOOTER=1
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType){
            ...
            FOOTER -> {
                val view = LayoutInflater.from(parent.context).inflate(R.layout.itemfooter_layout, parent, false)
        ...
        when(getItemViewType(position)){
            ITEM->{
                ...
                itemViewHolder.itemView.setOnClickListener {
                    ...
                    val dataTitle = dataList[position].chestTitle
...
//                    customDialog.show()
    ...
    inner class FooterViewHolderClass(itemView: View, private val context: Context) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindFooterData(){
            footerImageView.setImageResource(R.drawable.plus)
        }
    }
